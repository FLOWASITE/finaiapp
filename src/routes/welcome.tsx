...
export const Route = createFileRoute("/welcome")({
  head: () => ({
    meta: [
      { title: "FinAI — Kế toán AI cho doanh nghiệp Việt Nam" },
      {
        name: "description",
        content:
          "FinAI giúp kế toán SME tiết kiệm 80% thời gian nhập liệu: bóc tách hóa đơn, định khoản tự động theo Thông tư 133.",
      },
      { property: "og:title", content: "FinAI — Kế toán AI cho doanh nghiệp Việt Nam" },
      {
        property: "og:description",
        content:
          "Bóc tách hóa đơn và định khoản tự động theo TT133. Kế toán duyệt cuối, AI hỗ trợ.",
      },
    ],
  }),
  component: Landing,
