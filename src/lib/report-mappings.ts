...
export const B01_TT99: BSItem[] = [
  ...
  { ma_so: "122", name: "2. Dự phòng giảm giá chứng khoán kinh doanh (*)", level: 2, group: "asset",
    accounts: [C("2291", -1)] },
  { ma_so: "123", name: "3. Đầu tư nắm giữ đến ngày đáo hạn", level: 2, group: "asset",
    accounts: [D("128")] },

  { ma_so: "130", name: "III. Các khoản phải thu ngắn hạn", level: 1, group: "asset",
    formula: ["131", "132", "133", "134", "135", "136", "137", "139"] },
  ...
  { ma_so: "133", name: "3. Phải thu nội bộ ngắn hạn", level: 2, group: "asset",
    accounts: [D("136")] },
  { ma_so: "134", name: "4. Phải thu theo tiến độ kế hoạch HĐXD", level: 2, group: "asset",
    accounts: [D("337")] },
  { ma_so: "135", name: "5. Phải thu về cho vay ngắn hạn", level: 2, group: "asset",
    accounts: [D("1283")] },
  { ma_so: "136", name: "6. Phải thu ngắn hạn khác", level: 2, group: "asset",
    accounts: [D("138"), D("141"), D("244"), D("151")] },
  { ma_so: "137", name: "7. Dự phòng phải thu ngắn hạn khó đòi (*)", level: 2, group: "asset",
    accounts: [C("2293", -1)] },
  { ma_so: "139", name: "8. Tài sản thiếu chờ xử lý", level: 2, group: "asset",
    accounts: [D("1381")] },

  { ma_so: "140", name: "IV. Hàng tồn kho", level: 1, group: "asset",
    formula: ["141", "149"] },
  { ma_so: "141", name: "1. Hàng tồn kho", level: 2, group: "asset",
    accounts: [D("152"), D("153"), D("154"), D("155"), D("156"), D("157"), D("158")] },
  { ma_so: "149", name: "2. Dự phòng giảm giá hàng tồn kho (*)", level: 2, group: "asset",
    accounts: [C("2294", -1)] },

  { ma_so: "150", name: "V. Tài sản ngắn hạn khác", level: 1, group: "asset",
    formula: ["151", "152", "153", "154", "155"] },
  { ma_so: "151", name: "1. Chi phí trả trước ngắn hạn", level: 2, group: "asset",
    accounts: [D("242")] },
  { ma_so: "152", name: "2. Thuế GTGT được khấu trừ", level: 2, group: "asset",
    accounts: [D("133")] },
  { ma_so: "153", name: "3. Thuế và các khoản phải thu Nhà nước", level: 2, group: "asset",
    accounts: [D("333")] },
  { ma_so: "154", name: "4. Giao dịch mua bán lại trái phiếu Chính phủ", level: 2, group: "asset",
    accounts: [D("171")] },
  { ma_so: "155", name: "5. Tài sản ngắn hạn khác", level: 2, group: "asset",
    accounts: [D("2288")] },
  ...
  { ma_so: "210", name: "I. Các khoản phải thu dài hạn", level: 1, group: "asset",
    formula: ["211", "212", "213", "214", "215", "216", "219"] },
  { ma_so: "211", name: "1. Phải thu dài hạn của khách hàng", level: 2, group: "asset",
    accounts: [D("131")] },
  ...
  { ma_so: "215", name: "5. Phải thu về cho vay dài hạn", level: 2, group: "asset", accounts: [] },
  { ma_so: "216", name: "6. Phải thu dài hạn khác", level: 2, group: "asset",
    accounts: [D("244")] },
  { ma_so: "219", name: "7. Dự phòng phải thu dài hạn khó đòi (*)", level: 2, group: "asset", accounts: [] },

  { ma_so: "220", name: "II. Tài sản cố định", level: 1, group: "asset",
    formula: ["221", "224", "227"] },
  { ma_so: "221", name: "1. Tài sản cố định hữu hình", level: 2, group: "asset",
    accounts: [D("211"), C("2141", -1)] },
  { ma_so: "224", name: "2. Tài sản cố định thuê tài chính", level: 2, group: "asset",
    accounts: [D("212"), C("2142", -1)] },
  { ma_so: "227", name: "3. Tài sản cố định vô hình", level: 2, group: "asset",
    accounts: [D("213"), C("2143", -1)] },

  { ma_so: "230", name: "III. Bất động sản đầu tư", level: 1, group: "asset",
    accounts: [D("217"), C("2147", -1)] },

  { ma_so: "240", name: "IV. Tài sản dở dang dài hạn", level: 1, group: "asset",
    formula: ["241", "242"] },
  { ma_so: "241", name: "1. Chi phí sản xuất, kinh doanh dở dang dài hạn", level: 2, group: "asset", accounts: [] },
  { ma_so: "242", name: "2. Chi phí xây dựng cơ bản dở dang", level: 2, group: "asset",
    accounts: [D("241")] },

  { ma_so: "250", name: "V. Đầu tư tài chính dài hạn", level: 1, group: "asset",
    formula: ["251", "252", "253", "254", "255"] },
  { ma_so: "251", name: "1. Đầu tư vào công ty con", level: 2, group: "asset",
    accounts: [D("221")] },
  { ma_so: "252", name: "2. Đầu tư vào công ty liên doanh, liên kết", level: 2, group: "asset",
    accounts: [D("222")] },
  { ma_so: "253", name: "3. Đầu tư góp vốn vào đơn vị khác", level: 2, group: "asset",
    accounts: [D("2281")] },
  { ma_so: "254", name: "4. Dự phòng đầu tư tài chính dài hạn (*)", level: 2, group: "asset",
    accounts: [C("2292", -1)] },
  { ma_so: "255", name: "5. Đầu tư nắm giữ đến ngày đáo hạn", level: 2, group: "asset", accounts: [] },

  { ma_so: "260", name: "VI. Tài sản dài hạn khác", level: 1, group: "asset",
    formula: ["261", "262", "268"] },
  { ma_so: "261", name: "1. Chi phí trả trước dài hạn", level: 2, group: "asset",
    accounts: [D("242")] },
  { ma_so: "262", name: "2. Tài sản thuế thu nhập hoãn lại", level: 2, group: "asset",
    accounts: [D("243")] },
  { ma_so: "268", name: "3. Tài sản dài hạn khác", level: 2, group: "asset", accounts: [] },

  { ma_so: "270", name: "VII. Tài sản sinh học (TT99)", level: 1, group: "asset",
    accounts: [D("215"), C("2148", -1)] },
  ...
  { ma_so: "310", name: "I. Nợ ngắn hạn", level: 1, group: "liability",
    formula: ["311", "312", "313", "314", "315", "316", "317", "318", "319", "320", "321", "322"] },
  ...
  { ma_so: "314", name: "4. Phải trả người lao động", level: 2, group: "liability",
    accounts: [C("334")] },
  { ma_so: "315", name: "5. Chi phí phải trả ngắn hạn", level: 2, group: "liability",
    accounts: [C("335")] },
  { ma_so: "316", name: "6. Phải trả nội bộ ngắn hạn", level: 2, group: "liability",
    accounts: [C("336")] },
  { ma_so: "317", name: "7. Phải trả theo tiến độ kế hoạch HĐXD", level: 2, group: "liability",
    accounts: [C("337")] },
  { ma_so: "318", name: "8. Doanh thu chưa thực hiện ngắn hạn", level: 2, group: "liability",
    accounts: [C("3387")] },
  { ma_so: "319", name: "9. Phải trả ngắn hạn khác", level: 2, group: "liability",
    accounts: [C("3382"), C("3383"), C("3384"), C("3385"), C("3386"), C("3388"), C("3389"), C("138")] },
  { ma_so: "320", name: "10. Vay và nợ thuê tài chính ngắn hạn", level: 2, group: "liability",
    accounts: [C("341")] },
  { ma_so: "321", name: "11. Dự phòng phải trả ngắn hạn", level: 2, group: "liability",
    accounts: [C("352")] },
  { ma_so: "322", name: "12. Quỹ khen thưởng, phúc lợi", level: 2, group: "liability",
    accounts: [C("353")] },

  { ma_so: "330", name: "II. Nợ dài hạn", level: 1, group: "liability",
    formula: ["331", "332", "333", "334", "336", "337", "338", "339", "340", "341", "342"] },
  ...
  { ma_so: "333", name: "3. Chi phí phải trả dài hạn", level: 2, group: "liability", accounts: [] },
  { ma_so: "334", name: "4. Phải trả nội bộ dài hạn", level: 2, group: "liability", accounts: [] },
  { ma_so: "336", name: "5. Phải trả dài hạn khác", level: 2, group: "liability",
    accounts: [C("344")] },
  { ma_so: "337", name: "6. Vay và nợ thuê tài chính dài hạn", level: 2, group: "liability", accounts: [] },
  { ma_so: "338", name: "7. Trái phiếu chuyển đổi", level: 2, group: "liability",
    accounts: [C("3432")] },
  { ma_so: "339", name: "8. Cổ phiếu ưu đãi", level: 2, group: "liability", accounts: [] },
  { ma_so: "340", name: "9. Thuế thu nhập hoãn lại phải trả", level: 2, group: "liability",
    accounts: [C("347")] },
  { ma_so: "341", name: "10. Dự phòng phải trả dài hạn", level: 2, group: "liability", accounts: [] },
  { ma_so: "342", name: "11. Quỹ phát triển khoa học và công nghệ", level: 2, group: "liability",
    accounts: [C("356")] },
  ...
  { ma_so: "410", name: "I. Vốn chủ sở hữu", level: 1, group: "equity",
    formula: ["411", "412", "413", "414", "415", "416", "417", "418", "420", "421", "422"] },
  ...
  { ma_so: "418", name: "8. Quỹ đầu tư phát triển", level: 2, group: "equity",
    accounts: [C("414")] },
  { ma_so: "420", name: "9. Quỹ khác thuộc vốn chủ sở hữu", level: 2, group: "equity",
    accounts: [C("418")] },
  { ma_so: "421", name: "10. Lợi nhuận sau thuế chưa phân phối", level: 2, group: "equity",
    accounts: [C("421")] },
  { ma_so: "422", name: "11. Nguồn vốn đầu tư XDCB", level: 2, group: "equity",
    accounts: [C("441")] },

  { ma_so: "430", name: "II. Nguồn kinh phí và quỹ khác", level: 1, group: "equity",
    formula: ["431", "432"] },
  { ma_so: "431", name: "1. Nguồn kinh phí", level: 2, group: "equity",
    accounts: [C("461")] },
  { ma_so: "432", name: "2. Nguồn kinh phí đã hình thành TSCĐ", level: 2, group: "equity",
    accounts: [C("466")] },
