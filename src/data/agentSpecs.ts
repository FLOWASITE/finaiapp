...
export const agentSpecs: Record<AgentId, AgentSpec> = {
  ...
  extract: {
    ...
    rules: [
      ...
      { id: "ex-007", title: "Hóa đơn ngoại tệ", detail: "Bắt buộc ghi tỷ giá ngày phát hành theo NHNN; nếu thiếu thì fetch từ exchangerate-api hoặc VCB", severity: "mandatory", reference: "TT200 Điều 6" },
